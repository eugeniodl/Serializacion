...
switch(op)
{
    case "s":
        ...
        {
            Console.Write("No es una entrada válida. Introduzca un valor entero: ");
            valorCuenta = Console.ReadLine()!;
        }
        ...
        {
            Console.Write("No es una entrada válida. Introduzca un valor decimal: ");
            valorSaldo = Console.ReadLine()!;
        }
    ...
    case "d":
        ...
        miStream = new FileStream("clientes.xml", FileMode.Open, FileAccess.Read);
